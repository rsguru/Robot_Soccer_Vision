...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<locations>)))
  ...
  "a28bb17570907c28d276ade19cd9ea89")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'locations)))
  "Returns md5sum for a message object of type 'locations"
  "a28bb17570907c28d276ade19cd9ea89")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<locations>)))
  ...
  (cl:format cl:nil "Header header~%int32 home1_x~%int32 home1_y~%int32 home1_theta~%int32 ball_x~%int32 ball_y~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'locations)))
  "Returns full string definition for message of type 'locations"
  (cl:format cl:nil "Header header~%int32 home1_x~%int32 home1_y~%int32 home1_theta~%int32 ball_x~%int32 ball_y~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
