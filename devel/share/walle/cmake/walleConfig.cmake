...
if("TRUE" STREQUAL "TRUE")
  set(walle_SOURCE_PREFIX /home/ecestudent/catkin_ws/src/soccer)
  set(walle_DEVEL_PREFIX /home/ecestudent/catkin_ws/devel)
  set(walle_INSTALL_PREFIX "")
  set(walle_PREFIX ${walle_DEVEL_PREFIX})
else()
  set(walle_SOURCE_PREFIX "")
  set(walle_DEVEL_PREFIX "")
  set(walle_INSTALL_PREFIX /home/ecestudent/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'walle' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ecestudent <ecestudent@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'walle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ecestudent/catkin_ws/src/soccer/${idir}'.  Ask the maintainer 'ecestudent <ecestudent@todo.todo>' to fix it.")
    endif()
...
set(walle_EXPORTED_TARGETS "walle_generate_messages_cpp;walle_generate_messages_eus;walle_generate_messages_lisp;walle_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${walle_dep}_FOUND)
      find_package(${walle_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${walle_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "walle-msg-extras.cmake")
